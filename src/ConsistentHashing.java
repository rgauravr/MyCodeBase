...
import java.util.*;
 ...
 public class ConsistentHashing {
    ...
    private long generateHash(String key) {
      ...
      //  System.out.println(((long) (digest[3] & 0xFF) << 24));
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        System.out.println("key2: is present on server: " + ch.getServer("key2"));
        System.out.println("key67891: is present on server: " + ch.getServer("key67891"));
